...
RSpec.describe GildedRose do
  ...
  describe("#tick") do
    context "after sell date" do
      ...
      it "decreases quality and days remaining" do    
        gr.tick
    ...
    context 'before sell date' do
      it "decreases days remaining and quality" do
    ...
    context 'normal item of zero quality' do
      it "decreases days remaining and does not decrease quality below 0" do
